...
clc;
path = 'C:\Users\RohitKumarReddy\Desktop\ver 0.83\MNIST\train-images.idx3-ubyte';
if(~exist(path,'file'))
...
%============Loading labels
path = 'C:\Users\RohitKumarReddy\Desktop\ver 0.83\MNIST\train-labels.idx1-ubyte';
if(~exist(path,'file'))
...
path = 'C:\Users\RohitKumarReddy\Desktop\ver 0.83\MNIST\t10k-images.idx3-ubyte';
if(~exist(path,'file'))
...
%============Test labels
path = 'C:\Users\RohitKumarReddy\Desktop\ver 0.83\MNIST\t10k-labels.idx1-ubyte';
if(~exist(path,'file'))
